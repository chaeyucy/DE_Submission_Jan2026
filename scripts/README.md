...
- Task 1 : **Basic upsert logic** from staging to gold layer tables with **assuming there are other metadata, logs (e.g., failure log), partition tables**. In real world scenario, there could be other engines to handle **idempotency**.
